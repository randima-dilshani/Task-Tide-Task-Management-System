...
const TASK_TYPE = {
  pending: "bg-red-600", // changed to red for pending
...
const TaskDetails = () => {
  ...
  style={{
    boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)",  // subtle default shadow
  }}
>
  ...
  <Button
    type="text"
    icon={<EyeOutlined style={{ color: "#6b7280", fontSize: "18px" }} />}
    href={`/getTask/${task._id}`}
    className="transition-colors duration-200 hover:text-blue-600"
  />
  <Button
    type="text"
    icon={<EditOutlined style={{ color: "#6b7280", fontSize: "18px" }} />}
  ...
  >
    <Button
      type="text"
      icon={<DeleteOutlined style={{ color: "#6b7280", fontSize: "18px" }} />}
